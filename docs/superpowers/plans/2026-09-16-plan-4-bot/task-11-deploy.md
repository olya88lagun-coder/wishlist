...
- [x] **Step 3: BotFather (делает пользователь)**
...
- [x] **Step 4: Мерж в master и сборка образов (с согласия пользователя)**
...
- [x] **Step 6: Администратор (пользователь + «да»)**
